...
BOT_TOKEN = environ.get('BOT_TOKEN', "8033579157:AAF1n4KKHvShAIPRK22Rkp8dQdwjYTIOCV8")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6228529975').split()] # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://anoojop11_db_user:<fU9Ocs0VSMPJvJ8F>@cluster0.ql18jq7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/anooj_op')
